...
export const STARTER_RECIPES: StarterRecipe[] = [
  {
    ...
    imageKey: 'sheet-pan-chicken-thighs',
    permanentNotes:
    ...
    instructionSections: [
      {
        ...
        lines: [
          ...
          'Toss the potatoes and garlic with two-thirds of the oil and half the salt and pepper directly on a rimmed sheet pan. Spread them to the edges.',
    ...
    instructionSections: [
      {
        ...
        lines: [
          ...
          'In the last 15 minutes of the simmer, cook the pasta to al dente and reserve a mugful of the cooking water.',
          'Toss the pasta with the sauce, loosening with the reserved water until it coats. Serve with Parmesan.',
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    imageKey: 'garlic-shrimp-stir-fry',
    permanentNotes:
    ...
    instructionSections: [
      {
        ...
        lines: [
          ...
          'Heat half the oil in a large skillet over high. Sear the shrimp 1 minute per side and move them to a plate — they will finish later.',
          'Add the remaining oil and the broccoli and cook 3 minutes without moving it much, to get some colour.',
          'Add the steaming water, cover, and steam 2 minutes.',
  ...
  },
  {
    ...
    imageKey: 'slow-cooker-pulled-pork',
    permanentNotes:
    ...
    instructionSections: [
      {
        title: null,
        lines: [
          'Pat the pork dry and cut it into large, roughly fist-sized pieces.',
  ...
  },
  {
    ...
    imageKey: 'black-bean-sweet-potato-chili',
    permanentNotes:
  ...
  },
  {
    ...
    imageKey: 'skillet-mac-and-cheese',
    permanentNotes:
  ...
  },
  {
    ...
    imageKey: 'brown-butter-chocolate-chip-cookies',
    permanentNotes:
  ...
  },
  {
    ...
    imageKey: 'grilled-lemon-herb-chicken',
    permanentNotes:
